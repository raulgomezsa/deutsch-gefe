    ...
    class ControlDialogo
    {
        ...
        */
        ...
        public void despedirse()
        {
            ...
            {
                case 1:
                    Program.bot.decir("Auf Wiedersehen mein Schatz!");
                    break;
                case 2:
                    Program.bot.decir("Mach's  gut!");
                    break;
                case 3:
                    Program.bot.decir("Vielen Dank! Auf Wiedersehen " + Program.bot.nombre_camarero + ".");
                    break;
            }
        ...
        public void repetirPedido()
        {
            ...
            {
                case 1:
                    Program.bot.decir("Ja, klar. Kein Problem!");
                    break;
                case 2:
                    Program.bot.decir("Ja, mein Schatz!");
                    break;
            }
        ...
        public void noEntiendo()
        {
            ...
            switch (ind)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Program.bot.decir("Was sagst du?");
                    break;
                case 3:
                    Program.bot.decir("Was meinen Sist du?");
                    break;
                case 4:
        ...
        public void estoyEsperando()
        {
            ...
            switch (ind)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Program.bot.decir("Wie lange dauert mein Essen?");
                    break;
            }
        }
        ...
        public void estoyAtendido()
        {
            ...
            switch (ind)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Program.bot.decir("Du kommst zu spät.");
                    break;
            }
        }
        ...
        public void responder_Estado()
        {
            ...
            {
                case 1:
                    Program.bot.decir("Danke, ich bin zufrieden.");
                    break;
                case 2:
                    Program.bot.decir("Mir geht's gut.");
                    break;
                case 3:
                    Program.bot.decir("Danke, ich habe alles.");
                    break;
            }
        }
        ...
        public void responder_insultoGraveNoCamarero()
        {
            ...
            {
                case 1:
                    Program.bot.decir("Eh, was habe ich dir getan?");
                    break;
                case 2:
                    Program.bot.decir("Aber was hast du denn?");
                    break;
                case 3:
                    Program.bot.decir("Was ist los mit dir?");
                    break;
            }
        }
        ...
        public void responder_Enfado()
        {
            ...
            {
                case 1:
                    Program.bot.decir("Entschuldige dich oder ich spreche nicht mehr mit dir.");
                    break;
                case 2:
                    Program.bot.decir("Ich spreche nicht mit dir bis du dich entschuldigt hast.");
                    break;
            }
        }
        ...
        public void responder_Disculpa()
        {
            ...
            {
                case 1:
                    Program.bot.decir("Okay, ich akzeptiere deine Entschuldigungen.");
                    break;
                case 2:
                    Program.bot.decir("Ich bin sehr verletzt, aber okay!");
                    break;
                case 3:
        ...
        public void responder_NoQuieroNada()
        {
            ...
            switch (ind)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Program.bot.decir("Momentan brauche ich nichts.");
                    break;
            }
        }
        ...
        public void responder_Piropo()
        {
            ...
            {
                case 1:
                    Program.bot.decir("Ay, wie suess!");
                    break;
                case 2:
                    Program.bot.decir("Oh! Wie schön!");
                    break;
                case 3:
                    Program.bot.decir("Oh! Willst du meine Telefonnummer?");
                    break;
            }
        }
        public void responder_intentoLigarDescarado()
        {
            ...
            switch (ind)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Program.bot.decir("Gehen wir diese Woche zusammen ins Kino?");
                    break;
            }
        }
        public void responder_intentoLigarIndiscreto()
        {
            ...
            {
                case 1:
                    Program.bot.decir("Aber natürlich!");
                    break;
                case 2:
                    Program.bot.decir("Wann hast du Zeit?");
                    break;
            }
        }
