...
namespace ClienteCafeteria
{
    class Bot
    {
        ...
        public void sentarseEnTierra()
        {
            cliente.Self.SitOnGround();
        }
        public void rotar()
        {
            //Vector3 rotacion = new Vector3(0, 0, 180);
            Vector3 pos_actual = cliente.Self.SimPosition;
            Vector3 new_pos = new Vector3(pos_actual.X, pos_actual.Y - (float)60.0, pos_actual.Z);
            cliente.Self.Movement.TurnToward(new_pos);
        }
